...
interface PostItemProps {
  ...
  handleStartEditPost: (id: string) => void
}

function PostItem({ post, handleDelete, handleStartEditPost }: PostItemProps) {
  const handleClickDelete = (id: string) => {
    handleDelete(id)
  }

  const handleClickStartEditPost = (id: string) => {
    handleStartEditPost(id)
  }
  return (
        ...
        <div>
          <div className="inline-flex rounded-md shadow-sm" role="group">
            <button
              ...
              onClick={() => handleClickStartEditPost(post.id)}
            >
              Edit
            </button>
            <button
