...
function CreatePost() {
  ...
  const editStartPost = useSelector((state: RootState) => state.blog.editStatePost)

  useEffect(() => {
    setFormData(editStartPost || initalState)
  }, [editStartPost])
      ...
      <form onSubmit={handleSubmit} onReset={handleCancelEdit}>
        ...
        <div className="mb-6 flex items-center">
          <input
            ...
            // onChange={handlOnchange}
          />
          <label className="ml-2 text-sm font-medium text-gray-900">Publish</label>
        </div>
        <div>
          {!editStartPost && (
            <>
